...
public:
	...
	static int DrawHealthBar_Pip(int health, int strength, Vector3D<int> v3d, const bool isBuilding);
	static int DrawHealthBar_PipAmount(int health, int strength, int Minimum, int iLength);
