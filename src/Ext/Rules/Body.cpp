...
void RulesExt::ExtData::LoadBeforeTypeData(RulesClass* pThis, CCINIClass* pINI)
{
	...
	// Ares 0.A
	this->DeactivateDimEMP.Read(exINI, "AudioVisual", "DeactivateDimEMP");
	this->DeactivateDimPowered.Read(exINI, "AudioVisual", "DeactivateDimPowered");
}
...
void RulesExt::ExtData::Serialize(T& Stm)
{
	Stm
		// Ares 0.A
		.Process(this->DeactivateDimEMP)
		.Process(this->DeactivateDimPowered)
		;
}
