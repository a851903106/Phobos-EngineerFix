	...
	ILocomotion : IUnknown
{
	...
	virtual Matrix3D __stdcall Draw_Matrix(VoxelIndexKey* pKey) = 0; //Fetch voxel draw matrix.
	virtual Matrix3D __stdcall Shadow_Matrix(VoxelIndexKey* pKey) = 0;	//Fetch shadow draw matrix.
